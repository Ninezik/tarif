WITH base AS (
    ...
    AND connote__chargeable_weight = 1
    AND custom_field__jenis_barang = 'Paket'
    AND connote__connote_service NOT IN ('LN INCOMING','PJB','PJE')
